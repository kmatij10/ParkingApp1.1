...
namespace Parking.Data.Migrations
{
    ...
    [Migration("20200816131251_Initialize")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Parking.Data.Entities.Availability", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Parking.Data.Entities.ParkingSpace", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ParkingTypeId = 1L,
                            RateId = 1L,
                            Start = new DateTime(2020, 8, 16, 15, 12, 51, 364, DateTimeKind.Local).AddTicks(7697)
                        },
                        new
                        {
                            Id = 2L,
                            ...
                            ParkingTypeId = 2L,
                            RateId = 3L,
                            Start = new DateTime(2020, 8, 16, 15, 12, 51, 366, DateTimeKind.Local).AddTicks(6820)
                        },
                        new
                        {
                            Id = 3L,
                            ...
                            ParkingTypeId = 1L,
                            RateId = 1L,
                            Start = new DateTime(2020, 8, 16, 15, 12, 51, 366, DateTimeKind.Local).AddTicks(6908)
                        },
                        new
                        {
                            Id = 4L,
                            ...
                            ParkingTypeId = 1L,
                            RateId = 1L,
                            Start = new DateTime(2020, 8, 16, 15, 12, 51, 366, DateTimeKind.Local).AddTicks(6916)
                        },
                        new
                        {
                            Id = 5L,
                            ...
                            ParkingTypeId = 2L,
                            RateId = 2L,
                            Start = new DateTime(2020, 8, 16, 15, 12, 51, 366, DateTimeKind.Local).AddTicks(6919)
                        });
                });
            ...
            modelBuilder.Entity("Parking.Data.Entities.ParkingSpace", b =>
                {
                    b.HasOne("Parking.Data.Entities.Availability", null)
